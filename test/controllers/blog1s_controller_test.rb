...
class Blog1sControllerTest < ActionController::TestCase
  ...
  test "should create blog1" do
    assert_difference('Blog1.count') do
      post :create, blog1: { author_name: @blog1.author_name, content: @blog1.content, string: @blog1.string, string: @blog1.string, text: @blog1.text, title: @blog1.title }
    end
  ...
  test "should update blog1" do
    patch :update, id: @blog1, blog1: { author_name: @blog1.author_name, content: @blog1.content, string: @blog1.string, string: @blog1.string, text: @blog1.text, title: @blog1.title }
    assert_redirected_to blog1_path(assigns(:blog1))
  end
